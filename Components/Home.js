...
const Home = () => {
  ...
  return (
    <ScrollView className="bg-custom-blue flex py-4">
      ...
      <View className="w-[100%] mt-[15px] flex flex-row justify-center space-x-2">
        <View className="bg-blue-950 p-3 rounded-2xl w-[45%]">
          <Text className="text-sm text-gray-300 font-bold">Recent SGPA:</Text>
          <Text className="text-blue-100 font-extrabold ml-[15px] text-[50px]">{/* Recent sgpa */}</Text>
        </View>

        <View className="bg-blue-900 p-3 rounded-2xl w-[45%]">
          <Text className="text-sm text-gray-300 font-bold">Current CGPA:</Text>
          <Text className="text-blue-100 font-extrabold ml-[15px] text-[50px]">{/**show here the calucted gpa */}</Text>
        </View>
      </View>
    </ScrollView>
  );
